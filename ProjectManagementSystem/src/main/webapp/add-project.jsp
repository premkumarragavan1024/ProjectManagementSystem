			...
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							<li><a class="active" href="add-project.jsp">Add Project</a></li>
				...
				<div class="row col-md-12">
					...
					<div class="col-md-6 col-sm-12">
							...
							<div class="form-group" style="border-bottom: 3px solid black ;">
								<label><h3>Project Details</h3></label><br/>
					...
					<div class="row  text-right" > 
						<div class="btn-group" role="group" aria-label="Basic example">
							<button type="button" class="btn btn-success" onclick="saveProject();"><i class="fa fa-save"></i>&nbsp;Save</button>
...
<form class="page-header" name="Project_form" id="Project_form" method="post">
	<div class="row">
		<div class="col-md-3 col-sm-12">
			<div class="form-group">
				<label><h6>Project Name<span class="text-danger">*</span></h6></label>
				<input type="text" class="form-control" name="Project_Name" id="Project_Name">
			</div>
		</div>
		<div class="col-md-3 col-sm-12">
			<div class="form-group">
				<label><h6>Client Name<span class="text-danger">*</span></h6></label>
				<input type="text" class="form-control" name="Client_name" id="Client_name">
			</div>
		</div>
		<div class="col-md-3 col-sm-12">
			<div class="form-group">
				<label><h6>Project Type<span class="text-danger">*</span></h6></label>
	...
	<div class="row">
		<div class="col-md-3 col-sm-12">
			<div class="form-group">
				<label><h6>Project Manager<span class="text-danger">*</span></h6></label>
        ...
        <div class="col-md-3 col-sm-12">
			<div class="form-group">
				<label><h6>Frontend Technology<span class="text-danger">*</span></h6></label>
				<input type="text" class="form-control" name="Frontend_Technology" id="Frontend_Technology">
			</div>
		</div>
        <div class="col-md-3 col-sm-12">
			<div class="form-group">
				<label><h6>Backend Technology<span class="text-danger">*</span></h6></label>
				<input type="text" class="form-control" name="Backend_Technology" id="Backend_Technology">
			</div>
		</div>
	</div>
    <div class="row">
		<div class="col-md-4 col-sm-12">
			<div class="form-group">
				<label><h6>Project Details<span class="text-danger">*</span></h6></label>
                <textarea name="Project_Details" id="Project_Details" class="form-control"  style="height: 100px;"></textarea>
			</div>
		</div>
    </div>
</form>
