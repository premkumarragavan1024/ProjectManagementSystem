			...
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							<li><a class="active" href="add-timesheed.jsp">Add TimeSheet</a></li>
				...
				<div class="row col-md-12">
					...
					<div class="col-md-6 col-sm-12">
							...
							<div class="form-group" style="border-bottom: 3px solid black ;">
								<label><h3>Add TimeSheet Form</h3></label>
					...
					<div class="row  text-right" > 
						<div class="btn-group" role="group" aria-label="Basic example">
							<button type="button" class="btn btn-success" onclick="saveTimesheet();"><i class="fa fa-save"></i>&nbsp;Save</button>
...
<form class="page-header" name="Timesheet_form" id="Timesheet_form" method="post" >
    ...
    <div class="row">
		<div class="col-md-4 col-sm-12">
			<div class="form-group">
				<label><h6>Work Title<span class="text-danger">*</span></h6></label>
				<input name="work_Title" id="work_Title" type="text" class="form-control">
			</div>
		</div>
	</div>
    ...
    <div class="row">
		<div class="col-md-4 col-sm-12">
			<div class="form-group">
				<label><h6>Work Description<span class="text-danger">*</span></h6></label>
    ...
    <div class="row">
		<div class="col-md-4 col-sm-12">
			<div class="form-group">
				<label><h6>Total Working Hours<span class="text-danger">*</span></h6></label>
				<input name="Working_Hours" id="Working_Hours" type="text" class="form-control">
			</div>
		</div>
	</div>
        ...
        <div class="col-md-4 col-sm-12 mt-3">
			<div class="form-group">
				<div class="dropdown bootstrap-select form-control">
					<div class=" col-sm-12">
						<div class="form-group">
							<label><h6>Date<span class="text-danger">*</span></h6></label>
							<input name="Date" id="date" type="text" class="form-control date-picker">
						</div>
					</div>
			</div>
			</div>
