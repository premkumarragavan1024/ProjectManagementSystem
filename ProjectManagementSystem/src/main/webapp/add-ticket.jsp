			...
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							<li><a class="active"  href="add-ticket.jsp">Add Tickets</a></li>
				...
				<div class="row col-md-12">
					...
					<div class="col-md-6 col-sm-12">
							...
							<div class="form-group" style="border-bottom: 3px solid black ;">
								<label><h3>Create Ticket Form</h3></label>
								<small><span class="text-danger">
									<br><b>* denotes the field is mandatory.</b></span></small>
							</div>
						</div>
						<br/> 
						<div class=" col-md-4 justify-content-end align-content-end" style="float: right;"  >
							...
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item ">Ticket Form</li>
					...
					<div class="row  text-right" > 
						<div class="btn-group" role="group" aria-label="Basic example">
							<button type="button" class="btn btn-success" onclick="saveTicket();"><i class="fa fa-save"></i>&nbsp;Save</button>
...
<form class="page-header" name="Ticket_form" id="Ticket_form" method="post">
	
	<div class="row">
		<div class="col-md-4 col-sm-12">
			<div class="form-group">
				<label><h6>Ticket Title<span class="text-danger">*</span></h6></label>
				<input type="text" class="form-control" name="Ticket_title" id="Ticket_title">
			</div>
		</div>
		<div class="col-md-4 col-sm-12">
			<div class="form-group">
				<label><h6>Ticket Hours<span class="text-danger">*</span></h6></label>
				<input type="text" class="form-control" name="Ticket_hours" id="Ticket_hours">
			</div>
		</div>
    ...
    <div class="row">
		<div class="col-md-4 col-sm-12">
			<div class="form-group">
				<label><h6>Project Code<span class="text-danger">*</span></h6></label>
				<div class="dropdown bootstrap-select form-control">
                    <select name="Project_code" id="Project_code" class="selectpicker form-control" data-style="btn-outline-secondary" data-size="5" tabindex="-98">
                    <optgroup>
		...
		<div class="col-md-4 col-sm-12">
			<div class="form-group">
				<label><h6>Employee Code<span class="text-danger">*</span></h6></label>
				<div class="dropdown bootstrap-select form-control">
                    <select name="Emp_code" id="Emp_code" class="selectpicker form-control" data-style="btn-outline-secondary" data-size="5" tabindex="-98">
                    <optgroup>
	...
	<div class="row">
		<div class="col-md-4 col-sm-12">
			<div class="form-group">
				<label><h6>Ticket Type<span class="text-danger">*</span></h6></label>
				<div class="dropdown bootstrap-select form-control">
                    <select  name="Ticket_type" id="Ticket_type" class="selectpicker form-control" data-style="btn-outline-secondary" data-size="5" tabindex="-98">
                    <optgroup>
		...
		<div class="col-md-4 col-sm-12">
			<div class="form-group">
				<label><h6>Ticket Status<span class="text-danger">*</span></h6></label>
				<div class="dropdown bootstrap-select form-control">
                    <select name="Ticket_status" id="Ticket_status" class="selectpicker form-control" data-style="btn-outline-secondary" data-size="5" tabindex="-98">
                    <optgroup>
		...
		<div class="col-md-4 col-sm-12 mt-3">
			<div class="form-group">
				<div class="dropdown bootstrap-select form-control">
					<div class=" col-sm-12">
						<div class="form-group">
							<label><h6>Start Date<span class="text-danger">*</span></h6></label>
							<input name="Start_Date" id="Start_Date" type="text" class="form-control date-picker">
						</div>
					</div>
			</div>
			</div>
        ...
        <div class="col-md-4 col-sm-12 mt-3">
			<div class="form-group">
				<div class="dropdown bootstrap-select form-control">
					<div class=" col-sm-12">
						<div class="form-group">
							<label><h6>Due Date<span class="text-danger">*</span></h6></label>
							<input name="Due_Date" id="Due_Date" type="text" class="form-control date-picker">
						</div>
					</div>
			</div>
			</div>
    ...
    <div class="row">
		<div class="col-md-4 col-sm-12">
			<div class="form-group">
				<label><h6>Details<span class="text-danger">*</span></h6></label>
