			...
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							<li><a class="active" href="add-Leave.jsp">Add Employee Leave</a></li>
				...
				<div class="row col-md-12">
					...
					<div class="col-md-6 col-sm-12">
						...
						<div class=" col-md-4 justify-content-end align-content-end" style="float: right;"  >
							...
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item ">Leave Application Form</li>
					...
					<div class="row  text-right" > 
						<div class="btn-group" role="group" aria-label="Basic example">
							<button type="button" class="btn btn-success" onclick="saveLeave();"><i class="fa fa-save"></i>&nbsp;Save</button>
...
<form class="page-header" name="Leave_Form" id="Leave_Form" method="post">
    <div class="row">
    ...
    <div class="row">
		<div class="col-md-4 col-sm-12">
			<div class="form-group">
				<label><h6>Reason For Leave<span class="text-danger">*</span></h6></label>
    ...
    <div class="row">
		<div class="col-md-4 col-sm-12">
			<div class="form-group">
				<label><h6>Description<span class="text-danger">*</span></h6></label>
        ...
        <div class="col-md-4 col-sm-12 mt-3">
			<div class="form-group">
				<div class="dropdown bootstrap-select form-control">
					<div class=" col-sm-12">
						<div class="form-group">
							<label><h6>From Date<span class="text-danger">*</span></h6></label>
							<input name="From_Date" id="From_Date" type="text" class="form-control date-picker">
						</div>
					</div>
			</div>
			</div>
        ...
        <div class="col-md-4 col-sm-12 mt-3">
			<div class="form-group">
				<div class="dropdown bootstrap-select form-control">
					<div class=" col-sm-12">
						<div class="form-group">
							<label><h6>To Date<span class="text-danger">*</span></h6></label>
							<input name="To_Date" id="To_Date" type="text" class="form-control date-picker">
						</div>
					</div>
			</div>
			</div>
    ...
    <div class="row">
		<div class="col-md-4 col-sm-12">
			<div class="form-group">
				<label><h6>Leave Status<span class="text-danger">*</span></h6></label>
				<div class="dropdown bootstrap-select form-control">
                    <select name="Status" id="Status" class="selectpicker form-control" data-style="btn-outline-secondary" data-size="5" tabindex="-98">
                    <optgroup>
