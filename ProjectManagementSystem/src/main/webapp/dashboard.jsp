				...
				<div class="page-header">
					<div class="row">
						<div class="btn-list col-md-4">
							<a href="add-employee.jsp" class="btn btn-secondary  btn-lg btn-block " role="button">Add Employee</a>
						</div>
					</div>
					<div class="row">
						<div class="btn-list col-md-4">
							<a href="add-project.jsp" class="btn btn-secondary  btn-lg btn-block " role="button">Add Project</a>
						</div>
					</div>
					<div class="row">
						<div class="btn-list col-md-4">
							<a href="add-assignment.jsp" class="btn btn-secondary  btn-lg btn-block " role="button">Add Assignment</a>
						</div>
					</div>
					<div class="row">
						<div class="btn-list col-md-4">
							<a href="add-ticket.jsp" class="btn btn-secondary  btn-lg btn-block " role="button">Add Tickets</a>
						</div>
					</div>
					<div class="row">
						<div class="btn-list col-md-4">
							<a href="add-timesheed.jsp" class="btn btn-secondary  btn-lg btn-block " role="button">Add TimeSheet</a>
						</div>
					</div>
					<div class="row">
						<div class="btn-list col-md-4">
							<a href="add-leave.jsp" class="btn btn-secondary btn-lg btn-block " role="button">Add Leave</a>
						</div>
					</div>
				</div>
				</div>
